...
Methodology:
Data Preprocessing                                                                                   Combined all textual fields into a single full_text feature.                                                 Handled missing values by replacing them with empty strings
Feature extraction:                                                                                                 To convert text into numerical features:
...
Click predict
Instantly see predicted difficulty class and predicted difficulty score
